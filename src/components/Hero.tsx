      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="mb-6">
              <h1 className="text-6xl lg:text-8xl font-bold text-gray-900 mb-4 theme-security:text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
              <button className={`${buttonColors[theme]} text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-2xl flex items-center gap-3 text-lg`}>
          ...
          <div className="flex justify-center">
            <div className="relative">
              {/* Animated rings */}
              <div className={`absolute inset-0 rounded-full bg-gradient-to-br ${themeColors[theme]} blur-3xl opacity-20 scale-110 animate-pulse`} />
              <div className={`absolute inset-0 rounded-full bg-gradient-to-br ${themeColors[theme]} blur-2xl opacity-30 scale-105 animate-ping`} />
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-purple-500 rounded-full animate-bounce opacity-80" style={{ animationDelay: '0.5s' }} />
              <div className="absolute top-1/2 -left-8 w-4 h-4 bg-red-500 rounded-full animate-bounce opacity-80" style={{ animationDelay: '1s' }} />
            </div>
          </div>
        </div>
      </div>
